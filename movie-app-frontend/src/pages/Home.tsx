        ...
        <div>
            <div className="relative bg-stone-800">
                ...
                <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                    <h1 className="text-2xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-4xl">Blues 2s Chews & Reviews </h1>
                    <div className="mt-6 max-w-3xl text-sm sm:text-xl text-blue-200">
                        <ul>
