...
function Recommend() {
    ...
    return (
        <div className="bg-stone-800 max-w-screen-xl px-6">
            <div className="text-stone-400 text-center text-2xl mb-3 bg-stone-900 w-full p-2 rounded-full">Recommendeds from <span className="text-blue-200 italic font-bold">{singleMovie.title}</span></div>
