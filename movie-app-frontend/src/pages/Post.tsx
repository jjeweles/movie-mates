        ...
        <div className="flex flex-col min-h-fit py-2 mx-10">
            ...
            <div className="container lg bg-amber-50 rounded">
                ...
                <div className="flex flex-col gap-1.5 text-sm p-2">
                    <div className="flex gap-1.5">
                        <span className="font-bold text-black/60 mr-1">
                            <FontAwesomeIcon icon={faSignsPost} size="sm"/>
                        </span>
                        <button>Launch HN: OutSail (YC W23) – Wingsails to reduce cargo ship fuel consumption</button>
                    </div>
                    ...
                    <div className="flex gap-1.5 text-black/60 text-sm ml-5">
                    ...
                    <div className="flex flex-col gap-1.5 text-sm p-2 mt-7">
                        <div className="flex gap-1.5">
                            ...
                            <div className="flex gap-1.5 text-xs text-black/60">
