                ...
                <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                    <div className="relative flex items-center justify-between h-16">
                        <div className="flex-1 flex items-center justify-between">
                            ...
                            {/*  Mobile Navigation  */}
                            <div className="fixed top-0 right-0 z-10 mt-2 mr-2 sm:hidden flex flex-col">
                                ...
                                <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} sm:hidden bg-stone-800 p-4 rounded-lg transition duration-300 ease-in-out`} id="mobile-menu">
                                    <div className="w-screen h-screen text-center px-2 pt-2 pb-3 space-y-14">
                                        <Link to="/popular" className="text-stone-300 hover:bg-stone-700 hover:text-white block px-3 py-2 rounded-md text-2xl font-medium" onClick={closeMobileMenu}>Popular</Link>
                                        <Link to="/nowplaying" className="text-stone-300 hover:bg-stone-700 hover:text-white block px-3 py-2 rounded-md text-2xl font-medium" onClick={closeMobileMenu}>Now Playing</Link>
                                        <Link to="/toprated" className="text-stone-300 hover:bg-stone-700 hover:text-white block px-3 py-2 rounded-md text-2xl font-medium" onClick={closeMobileMenu}>Top Rated</Link>
                                        {userID && userID !== "undefined" ?
                                            <Link to={`/dashboard/${userID}`} className="text-stone-300 hover:bg-stone-700 hover:text-white block px-3 py-2 rounded-md text-2xl font-medium" onClick={closeMobileMenu}>Dashboard</Link>
                                            : null}
                                        {userID == null || userID === "undefined" ?
                                            <>
                                                <Link to="/login" className="text-stone-300 hover:bg-stone-700 hover:text-white block px-3 py-2 rounded-md text-2xl font-medium" onClick={closeMobileMenu}>Login</Link>
                                                <Link to="/register" className="text-stone-300 hover:bg-stone-700 hover:text-white block px-3 py-2 rounded-md text-2xl font-medium" onClick={closeMobileMenu}>Register</Link>
                                            </>
                                            : null}
                                        {userID && userID !== "undefined" ?
                                            <button className="text-stone-300 hover:bg-stone-700 hover:text-white text-center px-3 py-2 rounded-md text-2xl font-medium" onClick={handleClick}>Logout</button>
                                            : null}
                                    </div>
                                </div>
                            </div>
